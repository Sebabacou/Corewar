...
size_t fct_xor_second(vm_t *vm, size_t arg_size_two, size_t second_arg)
{
...
size_t fct_xor_first(vm_t *vm, size_t size_arg_one, size_t first_arg)
{
...
int fct_xor(vm_t *vm)
{
    ...
    first_arg = fct_xor_first(vm, size_arg_one, first_arg);
    second_arg = fct_xor_second(vm, arg_size_two, second_arg);
